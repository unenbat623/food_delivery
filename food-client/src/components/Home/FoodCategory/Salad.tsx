...
export const Salad = () => {
  const { foods } = useFood();
  const saladFoods = foods.filter((f) => f.category === "cat_salad").slice(0, 4);

  if (saladFoods.length === 0) return null;
    ...
    <Container maxWidth="xl" sx={{ mb: 8 }}>
      <Stack spacing={3}>
        ...
        >
          ...
          <Link href="/menu?category=cat_salad" style={{ textDecoration: "none" }}>
            <Button
